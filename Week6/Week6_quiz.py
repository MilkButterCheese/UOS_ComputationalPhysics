...
print(r) #r0, r1값 [-5,10] , [-0.930, 0.465]
print(s) #s0 s1 값 [-5 10], [-0.973 0.378]
print(a[0]) #alpba 0 값 0.116279
print(d[0]) # beta 0 값 0.008653
print(x) #x0,x1,x2 값 [1,2] [4.18604651e-01, 8.37209302e-01] ,[0,1]
